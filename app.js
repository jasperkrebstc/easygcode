...
(function () {
  ...
  function syncAccelToWallFeedHint(cfg) {
    ...
    hint.textContent =
      ...
      ' — shortened if another spike, zone, or the loop\'s own end is closer than that (a ramp cut short right' +
      ' at one layer\'s own end still continues into the next). Applies to any feed-rate increase, not just' +
      ' these, e.g. a slower bump feed handing back to the wall too.';
  }
